...
def index():
    ...
    if request.method == 'POST':
        ...
        lstm_predictions = make_predictions(lstm_model, scaled_data, train_data_len, scaler)

        gru_model = build_and_train_model(x_train, y_train, model_type='GRU')
        gru_predictions = make_predictions(gru_model, scaled_data, train_data_len, scaler)
    ...
    return render_template('index.html', plot_div_lstm=plot_div_lstm, plot_div_gru=plot_div_gru, candlestick_div=candlestick_div, ticker=ticker, error=None)
